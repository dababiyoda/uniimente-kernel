"""Canonical 55-technology arsenal for the Asymmetric Advantage Foundry.

The registry is descriptive and selection-oriented. A registry entry does not
claim that its technology is production-complete. Status is explicit so the
Composer cannot confuse target architecture with executable capability.
"""
...
def _t(
    ...
    surfaces: tuple[str, ...],
    deps: tuple[int, ...] = (),
    consequence: str = "internal_write",
    description: str = "",
) -> TechnologySpec:
    spec = TechnologySpec(
        id=id,
    ...
    if problems:
        raise ValueError(f"invalid arsenal entry {id}: {problems}")
    return spec


# Status reflects repository reality at Foundry v0, not eventual ambition.
_ENTRIES = (
    ...
    _t(39, "Double-entry accounting", "commerce", "target", ("capital", "settlement", "measurement"), (38,), "financial"),
    ...
    _t(47, "Business Architecture Compiler", "venture", "target", ("venture", "composition"), (1, 12, 13)),
    ...
    _t(50, "Rabbit Hole Engine", "media", "target", ("media", "distribution", "customer"), (18, 19, 34, 49), "external_contact"),
    ...
    _t(55, "Regenerative Treasury", "capital", "partial", ("capital", "regeneration", "settlement"), (39,), "financial"),
)
